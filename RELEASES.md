...
gh release create v0.22.0-rc.1 \
  ...
  --prerelease \
  frontend-desktop-tecu-v0.22.0-rc.1.tar.gz
```
...
npm ci --omit=dev
tar -czf frontend-desktop-tecu-v0.22.0-rc.1.tar.gz dist package.json package-lock.json node_modules
```
